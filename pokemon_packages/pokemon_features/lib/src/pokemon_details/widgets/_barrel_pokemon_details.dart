...
export '_pokemon_cry_widget.dart';
export '_pokemon_details_card_widgets/_pokemon_details_card_flavor_text_widget.dart';
export '_pokemon_details_card_widgets/_pokemon_details_card_genus_widget.dart';
...
export '_strong_against_widget.dart';
export '_weak_against_widget.dart';
